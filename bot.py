...
def handle_owner_buttons(data):
    ...
    if button == "broadcast":
        ...
        if check_subscription(chat_id):
            ...
            send_message(chat_id, "✅ Siz kanalga obuna bo‘ldingiz. Endi botni ishlatishingiz mumkin!")
        else:
            send_message(chat_id, "❌ Siz hali barcha kanallarga obuna bo‘lmadingiz!")
                ...
                for update in updates["result"]:
                    ...
                    if "message" in update:
                        ...
                        if is_instagram_url(text):
                            # Kanalga obuna bo‘lmaganlar ishlata olmaydi
                            if channels and not is_subscribed(chat_id):
                                continue
